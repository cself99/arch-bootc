...
RUN pacman -Sy --noconfirm --needed git base-devel wget whois && \
    ...
    aura --noconfirm -A sway-scroll-git dms-shell-bin gpu-screen-recorder-ui zen-browser-bin greetd-dms-greeter-git && \
    pacman -Sy --noconfirm xdg-desktop-portal-wlr xdg-desktop-portal-gtk ghostty restic grim slurp mpv flatpak helix dhcpcd pipewire pipewire-alsa pipewire-pulse mesa vulkan-radeon networkmanager bluez bluez-utils distrobox  && \
